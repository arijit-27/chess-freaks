...
const TournamentSchema = new Schema({
  ...
  revivalListA: [{ type: Schema.Types.ObjectId, ref: 'Player' }],
  revivalListB: [{ type: Schema.Types.ObjectId, ref: 'Player' }],
  allOutCountA: { type: Number, default: 0 },
  allOutCountB: { type: Number, default: 0 },
